		    ...
		    <footer className="page-footer">
		      <div className="container">
		        <div className="row">
		           ...
		           <div className="col l6 s12">
		              <p className="grey-text text-lighten-4">Doppelgänger gives you the tools to find new and exciting ideas, other points of view and lets you explore the world by providing you thought-provoking podcasts and inspiriational YouTube videos. The way to your new and improved self is just a click away! Sign up, answer our short questionnaire and begin seeing the world through the eyes of "the other".</p>
		           </div>
		        </div>
		      </div>
